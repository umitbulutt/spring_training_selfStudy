...
public class ComputerTest {
    public static void main(String[] args) {
        ...
        Case caseDell = container.getBean(Case.class);
        Motherboard motherboardAsus = container.getBean(Motherboard.class);

        PC myPc = new PC(caseDell,sonyMonitor,motherboardAsus);
